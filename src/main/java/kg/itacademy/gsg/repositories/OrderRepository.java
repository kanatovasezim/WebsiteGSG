...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("select new kg.itacademy.gsg.models.OrderModel(o.id,o.title,o.clientId,o.managerId,o.packageId,o.createdDate) FROM Order o WHERE o.managerId.id=:id ORDER BY o.id DESC")
    Page<OrderModel> findAllOrdersByManagerId(@Param("id") Long id, Pageable pageable);
